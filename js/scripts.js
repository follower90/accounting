...
var saveEntry = function (id) {
	...
	$.ajax({
		type: "POST", url: "/ajax/editsave", data: dataString, cache: false, success: function (html) {
...
var deleteEntry = function (id) {
	if (confirm('Вы уверены что хотите удалить?')) {
		...
		$.ajax({
			type: "POST", url: "/ajax/deleteentry", data: dataString, cache: false, success: function (html) {
